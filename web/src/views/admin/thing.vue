        ...
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="重量" name="zhongliang">
                  <a-input placeholder="请输入" v-model:value="modal.form.zhongliang" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="材质" name="caizhi">
                  <a-input placeholder="请输入" v-model:value="modal.form.caizhi" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('caizhi', modal.form.caizhi || '');
